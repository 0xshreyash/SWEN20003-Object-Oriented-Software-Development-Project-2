...
public class Constant {
	    ...
	    public static final String AMULET = "items/amulet.png";
	    
	    public static final String ELIXIR = "items/elixir.png";
	    
	    public static final String SWORD = "items/sword.png";
	    
	    public static final String TOME = "items/tome.png";
	    
	    public static final String BANDIT = "units/bandit.png";
	    
	    public static final String DREADBAT = "units/dreadbat.png";
	    
	    public static final String NECROMANCER = "units/necromancer.png";
	    ...
	    public static final String SKELETON = "units/skeleton.png";
	    
	    public static final String ZOMBIE = "units/zombie.png";
