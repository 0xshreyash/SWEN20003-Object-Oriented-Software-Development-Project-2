...
public class Character
{
	...
	private Image char_image_inverted = null;
     ...
     * of the player.
     */
	public Character(String playerImagePath) 
	throws SlickException
	{
		...
		char_image = new Image(playerImagePath);
		char_image_inverted = char_image.getFlippedCopy(true, false); 
	}
	...
	public void render(Graphics g, double cam_minX, double cam_minY)
	{
		...
		{
			char_image.drawCentered((float)xPos, (float)yPos);
		}
		else
		{
			char_image_inverted.drawCentered((float)xPos, (float)yPos);
		}		
	}
}
